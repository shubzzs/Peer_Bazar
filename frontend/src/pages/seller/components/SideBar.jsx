    ...
    return (
        <>
            <React.Fragment>
                ...
                {
                    currentRole === "Peer_Bazar" &&
                    <ListItemButton
                        component={Link} to="/Seller/Peer_Bazar"
                        sx={location.pathname.startsWith('/Seller/Peer_Bazar') ? styles.currentStyle : styles.normalStyle}
                    >
                        <ListItemIcon>
                            <AdminPanelSettingsIcon sx={{ color: location.pathname.startsWith("/Seller/Peer_Bazar") ? '#4d1c9c' : 'inherit' }} />
                        </ListItemIcon>
                        <ListItemText primary="Peer_Bazar" />
                    </ListItemButton>
                }
            </React.Fragment>
            <Divider sx={{ my: 1 }} />
